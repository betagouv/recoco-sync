...
LESCOMMUNS_PROJECT_SELECTION_ENABLED = env.bool(
    "LESCOMMUNS_PROJECT_SELECTION_ENABLED", default=True
)
LESCOMMUNS_RESOURCE_TAG_NAME = env.str("LESCOMMUNS_RESOURCE_TAG_NAME", default="les-communs")
